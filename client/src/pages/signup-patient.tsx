      ...
      <div className="w-full max-w-md">
        <Card className="bg-surface border border-bd">
          <CardHeader className="pb-4">
            <CardTitle className="text-2xl font-bold text-th">Patient Signup</CardTitle>
            <CardDescription className="text-tm">Create your account to start managing your knee health</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-2">
                  <Label htmlFor="height" className="text-ts text-sm">
                    Height (cm) *
                  </Label>
                  <Input
                    id="height"
                    ...
                    className={`bg-ib border-ibr text-th placeholder:text-tm focus:border-ac focus:ring-ac/20 ${heightError ? "border-red-500" : ""}`}
                    placeholder="e.g., 175"
                  />
                  {heightError && <p className="text-sm text-red-400">Height is required</p>}
                </div>
                <div className="space-y-2">
                  <Label htmlFor="weight" className="text-ts text-sm">
                    Weight (kg) *
                  </Label>
                  <Input
                    id="weight"
                    ...
                    className={`bg-ib border-ibr text-th placeholder:text-tm focus:border-ac focus:ring-ac/20 ${weightError ? "border-red-500" : ""}`}
                    placeholder="e.g., 70"
                  />
                  {weightError && <p className="text-sm text-red-400">Weight is required</p>}
                </div>
              </div>
